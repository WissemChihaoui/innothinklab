...
import brand1 from "@/public/images/brand/qatara-logo.jpg";
...
interface ProjectData {
  ...
  completedDate: string; // Changed from Date to string to match serialized data
  location: string;
  content: string;
  createdAt: string;
  updatedAt: string;
        ...
        <div className="seo-project-slider-inner">
          <Slider ref={sliderRef} {...mainSliderSettings} className="seo-project-slider">
            {projects.map((project: ProjectData) => {
              ...
              return (
                <div className="sa-project-item-wrap" key={project._id} style={{ height: "max-content" }}>
                    ...
                    <div className="xb-item--inner ul_li_between pos-rel z-1">
                      <div className="xb-item--project_title">
                        ...
                        <div className="xb-btn mt-50">
                          <Link href={`/casestudy/${project.slug}`} className="thm-btn thm-btn--border">Voir le projet<span><svg width="11" height="11" viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
